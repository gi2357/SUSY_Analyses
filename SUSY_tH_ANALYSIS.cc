...
namespace Rivet {
  ...
  class SUSY_tH_ANALYSIS : public Analysis {
  public:

    /// Constructor
    SUSY_tH_ANALYSIS()
      : Analysis("SUSY_tH_ANALYSIS")
    {    }
    ...
    void init() {
      ...
      _hist_met = bookHisto1D("Etmiss", 100, 0.0, 1200);
...
//      nvetoed=nvetoed1+nvetoed2+nvetoed3+nvetoed4;
...
//      cout << "Total Vetoed " << nvetoed << " events" << endl;
  ...
  DECLARE_RIVET_PLUGIN(SUSY_tH_ANALYSIS);
